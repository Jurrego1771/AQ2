...
test.describe('Live Stream advanced — endpoints del detalle @regression @live-stream', () => {
  ...
  // ─── 4. Paginacion ──────────────────────────────────────────────────────
  // LIVE-TC-40 (pagination) eliminado 2026-07-14: la asercion de estabilidad
  // hacia 2 list() separados y exigia IDs identicos -> fragil bajo fullyParallel
  // (un create concurrente desplaza la ventana). Se rehara bien (snapshot unico
  // sin 2a llamada). Definicion en knowledge-core (estado: deferred).
