...
test.describe('Show API @api - Contract', () => {
  ...
  test('SHW-TC-LST GET /api/show/list devuelve items con shape minimo (id/title/type) @SHW-TC-LST', async ({ apiToken: api }) => {
  ...
  test('SHW-TC-LST-ALL GET /api/show/list?all=true bypasea filtro de status @SHW-TC-LST-ALL', async ({ apiToken: api }) => {
